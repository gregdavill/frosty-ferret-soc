...
class HyperBusCrossbar(Module):
    ...
    def get_port(self, cs, request = None):
        user_port     = HyperBusSlavePort()
        internal_port = HyperBusSlavePort()
